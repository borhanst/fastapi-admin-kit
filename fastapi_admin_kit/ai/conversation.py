...
class ConversationRecorder:
    ...
    async def log_tool_call(self, conv: Any, call: Any) -> None:
        from fastapi_admin_kit.ai.usage import AIMessage
    ...
    async def log_error(self, conv: Any, error: str) -> None:
        from fastapi_admin_kit.ai.usage import AIMessage
...
def _with_conversation_logging(chat_fn: Any) -> Any:
...
def _with_conversation_logging_stream(chat_stream_fn: Any) -> Any:
...
def patch_agent_with_conversation_logging(agent_cls: type) -> None:
